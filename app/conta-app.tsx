      ...
      <aside className={menu ? "sidebar open" : "sidebar"}>
        ...
        <nav aria-label="التنقل الرئيسي">
          ...
          {can("reports.view")&&<div className="nav-menu report-nav-menu" ref={reportMenuRef}>
            ...
            {reportMenu && <div className="nav-popover report-nav-popover">{reportOrder.map(id => <button key={id} aria-current={view === "reports" && reportType === id ? "page" : undefined} className={view === "reports" && reportType === id ? "active" : ""} onClick={() => { setReportType(id); navigate("reports"); }}><span>{reportNames[id]}</span></button>)}</div>}
          </div>}
