...
export const CAPABILITIES = [
  ...
  "expenses.view","expenses.create","expenses.edit","expenses.delete","reports.view","settings.view","settings.general.manage","settings.branding.manage","settings.backup.manage","settings.legacy.import","settings.users.manage",
] as const;
