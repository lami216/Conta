...
export const DEFAULT_INVOICE_BRANDING: InvoiceBrandingSettings = { storeName: "Conta", nameFont: "tahoma", nameFontSize: 24, nameFontWeight: 800 };
...
export function validateInvoiceBranding(value: unknown): InvoiceBrandingSettings {
  ...
  return{storeName,nameFont:body!.nameFont as InvoiceFont,nameFontSize,nameFontWeight:nameFontWeight as 400|600|800};
}
